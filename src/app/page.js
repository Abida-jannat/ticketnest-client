...
const popularRoutes = [
  {
    title: "Dhaka ⇄ Sylhet",
    desc: "Most traveled corporate and leisure corridor.",
    count: "45+ Daily Trips",
  },
  {
    title: "Dhaka ⇄ Cox's Bazar",
    desc: "Direct overnight sleeper coaches to the beach.",
    count: "30+ Daily Trips",
  },
  {
    title: "Chittagong ⇄ Bandarban",
    desc: "Scenic mountain getaways with expert drivers.",
    count: "20+ Daily Trips",
  },
];
  ...
  return (
    <div className="flex flex-col gap-16 px-4 py-8 sm:px-6 lg:px-12">
      {/* =========================================
          Hero Banner Section
      ========================================== */}
      <section className="relative overflow-hidden rounded-3xl border border-gray-800 bg-gradient-to-b from-gray-900 to-gray-950 px-6 py-20 shadow-2xl sm:px-12 lg:py-28">
        <div className="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full bg-blue-600/15 blur-3xl" />
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-1.5 text-xs font-semibold text-blue-400">
            ...
            <span>
              Bangladesh Smart Travel Booking Platform
            </span>
          </div>

          <h1 className="text-4xl font-black tracking-tight text-white sm:text-6xl">
            Travel Deshi, Travel Smarter with{" "}
            <span className="text-blue-500">TicketNest</span>
          </h1>

          <p className="mt-4 text-base text-gray-400 sm:text-lg">
            Book verified intercity buses, comfortable private
            cars, and scenic holiday routes across Bangladesh
            instantly.
          </p>
      ...
      {/* =========================================
          ...
          Admin-approved + advertised tickets
      ========================================== */}
      <AdvertisementSection />

      {/* =========================================
          Main Requirement: Latest Tickets
          8 Newly Added Tickets
      ========================================== */}
      <section className="space-y-6">
        <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-end">
          ...
          <p className="max-w-sm text-xs text-gray-400">
            Browse the 8 most recently published travel
            tickets, buses, and private car options.
          </p>
        </div>
            ...
            >
              <div>
                ...
                <div className="relative h-44 w-full overflow-hidden bg-gray-900">
                  ...
                  <span className="absolute right-3 top-3 rounded-lg border border-gray-800 bg-gray-950/80 px-2.5 py-1 text-[11px] font-semibold text-white backdrop-blur-md">
                ...
                <div className="p-4">
                  ...
                  <div className="mt-3 flex flex-wrap gap-1">
                    {ticket.perks.map((perk, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center gap-1 rounded-md border border-gray-800 bg-gray-900 px-2 py-0.5 text-[10px] text-gray-300"
                      >
                        <Check
                          width={10}
                          height={10}
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {popularRoutes.map((route, i) => (
            <div
              key={i}
              className="flex flex-col justify-between rounded-2xl border border-gray-800 bg-gray-950 p-6"
            >
              <div>
      ...
      <section className="rounded-3xl border border-gray-800 bg-gradient-to-r from-gray-950 via-gray-900 to-gray-950 p-8 sm:p-12">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          ...
          <div className="space-y-2">
            <div className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-blue-500/20 bg-blue-600/10 text-blue-400">
            ...
            <p className="text-xs text-gray-400">
              All transport operators are authenticated
              directly by platform admin to ensure safety.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-400">
              Secure your seats in seconds with smooth,
              lightning-fast digital booking workflows.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-400">
              Dedicated help desk assistance for
              cancellations, schedule updates, and customer
              inquiries.
            </p>
          </div>
        </div>
